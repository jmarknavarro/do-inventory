	...
	{ {
			try {
				...
				foreach ($rows as $row) {
					...
					echo "<td>
					<a class='btn text-center btn-sm' href='edit-record.php?id=$row[serial_no]' data-id='$row[id]'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
